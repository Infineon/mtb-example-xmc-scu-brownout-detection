# XMC MCU: Brownout Detection

This code example demonstrates brownout detection by reducing power supply voltage from 3.3 V to the defined voltage threshold using brownout detection available in XMC&trade; MCU devices.
...
5. Decrease the supply voltage from 3.3V to 3.0V slowly
6. Confirm that the kit LED doesn't glow anymore
...
Document Title: *CE232799* - *XMC MCU: Brownout Detection*
